...
import { TrueCountTypeEnum } from "../models-constants-enums/enumerations";
...
export const hiLo: CountingStrategy = {
  ...
  trueCountPreference: TrueCountTypeEnum.FULL_FLOOR,
  convertToTrueCount: true,
};
